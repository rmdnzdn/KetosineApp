Public Class detail2
    ...
    Private Sub detail2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub identitas()
        konek()
        CMD = New OleDb.OleDbCommand("SELECT * FROM tbl_kandidat WHERE id_kandidat='2'", cn)
        ...
        Loop
    End Sub
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles lnama.Click

    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        kandidat.Enabled = True
        kandidat.idcan.Text = "2"
        pesan = "Siti Nurhania Haeriah"
        identitas()
        kandidat.lnamakan.Visible = True
        kandidat.lnamakan.Text = nama_kan
        kandidat.Label13.Text = "Pilih 2"
        kandidat.Label13.Visible = True
        kandidat.Button4.BackColor = Color.MediumAquamarine
